...
//      let validURL = Bundle.main.url(forResource: targetName + "Movie", withExtension: "mp4", subdirectory: nil) {       print(targetName)
        let validURL = Bundle.main.url(forResource: "Movie", withExtension: "mp4", subdirectory: nil){
