...
class ImageDownloader{
  ...
  static let BASE_PATH = ""// https://hsto.org/r/w1560/webt/as/wn/2l/ deffault path
    // TODO: move to config file
  
  static let payloadData: [ReferenceImagePayload] = [
    ReferenceImagePayload(name: "https://silvegfor.pythonanywhere.com/images/Timofey", extensionType: FileSuffix.jpg.name, orientation: .up, widthInM: 0.1),
